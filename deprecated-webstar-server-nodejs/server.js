...
class WebStarServer {
    ...
    setupWebSocket() {
        // Main signaling WebSocket server with Godot-compatible settings
        this.wss = new WebSocket.Server({
            ...
            verifyClient: (info) => {
                ...
                logger.debug('Headers:', info.req.headers);
                
                // Accept all connections - no origin checking for now
                return true;
            }
        });
        
        this.wss.on('connection', (ws, request) => {
            // Add some delay before handling connection to ensure Godot is ready
            setTimeout(() => {
    ...
    handleSignalingConnection(ws, request) {
        ...
        // Send welcome message only after ensuring WebSocket is ready
        // Add a small delay to ensure Godot's WebSocketPeer is ready to receive
        setTimeout(() => {
